...
from roamapi.views import register_user, login_user, TripView, TravelerView, DestinationView, TagView, StateView, TripDestinationView, TripTagView, ItemView, CategoryView, DestinationStatusView
...
router.register(r'destinationstatus', DestinationStatusView, 'destinationstatus')
