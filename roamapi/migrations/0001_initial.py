# Generated by Django 4.1.7 on 2023-03-17 00:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='destination_status', to='roamapi.status')),
        ...
        migrations.AddField(
            model_name='trip',
            name='tag',
            field=models.ManyToManyField(related_name='tags_of_trip', through='roamapi.TripTag', to='roamapi.tag'),
        ),
        migrations.AddField(
            model_name='trip',
            name='traveler',
